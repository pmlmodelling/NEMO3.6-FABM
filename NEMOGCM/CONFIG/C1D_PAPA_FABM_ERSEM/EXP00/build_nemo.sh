...
cd $NEMO_BUILD_DIR
echo "Building NEMO..."
./makenemo -m "GCC_UBUNTU" -n C1D_PAPA_TEST clean_config
...
./makenemo -m "GCC_UBUNTU" -r C1D_PAPA_FABM_ERSEM -n C1D_PAPA_TEST && rsync -a $NEMO_BUILD_DIR/C1D_PAPA_TEST/BLD/bin/nemo.exe $RUNDIR/
