MODULE inputs_fabm
   ...
   SUBROUTINE initialize_inputs
      ...
      DO
         ...
         IF( ierr > 0 ) CALL ctl_stop( 'STOP', 'inputs_fabm:initialize_inputs: unable to allocate input_variable object for variable '//TRIM(name) )
         ...
         CALL fld_fill(input_variable%sf, (/sn/), '', 'inputs_fabm:initialize_inputs', 'FABM variable '//TRIM(name), 'variable' )
